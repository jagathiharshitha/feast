...
from feast.infra.offline_stores.contrib.ociquery_offline_store.ociquery import (
...
class OciQueryDataSourceCreator(DataSourceCreator):
    ...
    def __init__(self, project_name: str, *args, **kwargs):
        ...
        self.offline_store_config = OciQueryOfflineStoreConfig(
    ...
    def create_logged_features_destination(self) -> LoggingDestination:
        ...
        return OciQueryLoggingDestination(table_name=table)
